...
public class SeleniumTestsContext {
	 ...
	 public XmlTest getTestLevelContext() {
	        return testNGContext.getCurrentXmlTest();
	    }
	 
	 public ISuite getSuiteLevelContext() {
	        return testNGContext.getSuite();
	    }
    ...
    public static final String BROWSER_NAME = "browserType";
    ...
    public String getTestLevelBrowserName() {
        return testNGContext.getCurrentXmlTest().getParameter(BROWSER_NAME).toLowerCase().trim();
    }
    public String getTestSuiteBrowserName() {
        return testNGContext.getSuite().getParameter(BROWSER_NAME).toLowerCase().trim();
    }
    public String getTestLevelDEVICE_NAME() {
        return testNGContext.getCurrentXmlTest().getParameter(DEVICE_NAME);
    }
    public String getTestSuiteDEVICE_NAME() {
        return testNGContext.getSuite().getParameter(DEVICE_NAME);
    }
