...
public class GoogleSheetAPI {
	...
	public static Credential authorize() throws IOException {
		// Load client secrets.
		InputStream in = new FileInputStream(new File(System.getProperty("user.dir")+"/client_secret.json"));
	...
	List<List<Object>> getSpreadSheetRecords(String spreadsheetId, String range) throws IOException {
