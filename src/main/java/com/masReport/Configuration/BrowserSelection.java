...
public class BrowserSelection {
	...
	public static WebDriver browserType(ITestContext context)
	{
		if(browserName==null)
		{
		browserName=context.getCurrentXmlTest().getParameter("browserType").toLowerCase().trim().toString();
		}
		switch(browserName){
		...
		case "apple":
			...
			mobileEmulation.put("deviceName", context.getCurrentXmlTest().getParameter("deviceName"));
